...
var FlatKeyboard = function(elem) {
    ...
    this.color={
        ...
        "text": {"logo": {"fill":"#69C969", "stroke":"#609060"}} //●696969 606060
    };
...
FlatKeyboard.prototype={
    ...
    onmessage: function(midiMsg) {
        ...
        var data={
            ...
            "velo": midiMsg[2].toString(16) //●追加velocity 0 ノートオフ用
        };
            ...
            for(var i=0; i<this.drawKeys.length; i++) {
                if(tko == (this.drawKeys[i].label.split(":")).join("")) {
                    ...
                    if(data.msg.substr(0, 1)=="9") {
                        //console.log(data.velo);//●ベロシティで判断
                        if(data.velo == 0){
                           this.drawKeys[i].on=false;
                        } else {
    ...
    draw: function() {
        ...
        this.context.fillStyle="#69C969"; //●マイナス背景 ffffff
        ...
        this.context.fillStyle="#69C969"; //●プラス背景 ffffff
        ...
        */
        ...
        // sign on control keys  //プラス・マイナスボタンを塗りつぶしに
        this.context.fillStyle="#ffffff"; //●プラス・マイナス #696969
        this.context.font="36px 'Arial'";
        this.context.fillText("-", this.drawSize.ctrlArea.octave.minus.left+16+0.5, 168+0.5);
        this.context.fillText("+", this.drawSize.ctrlArea.octave.plus.left+12+0.5, 168+0.5);
